...
def _ulysses_flash_attention_forward(
    ...
    **kwargs,
    ...
    """
    # Reduce 3D mRoPE position_ids (n_sections, batch, seq) -> 2D (batch, seq)
    # so HF's cu_seqlens derivation (_is_packed_sequence / _prepare_from_posids)
    # gets the 2D tensor it assumes. Without this flash_attn_varlen reads OOB.
