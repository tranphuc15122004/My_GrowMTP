...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    async def update_weights(self, global_steps: int = None, mode: str = "auto"):
        ...
        # Checkpoint gathering and head backward leave allocator slack. Release it
        # before SGLang remaps its weights, not only after the weight transfer.
        if self.actor.engine.model_config.mtp.growmtp:
            aggressive_empty_cache(force_sync=True)
