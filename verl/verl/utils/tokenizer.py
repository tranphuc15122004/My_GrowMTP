...
def hf_processor(name_or_path, **kwargs):
    ...
    try:
        ...
        # Some text checkpoints ship processor metadata but only a tokenizer chat template.
        # Falling back to the tokenizer avoids routing text through a template-less processor.
