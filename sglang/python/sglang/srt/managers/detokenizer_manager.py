...
class DetokenizerManager(MultiHttpWorkerDetokenizerMixin):
    ...
    def handle_batch_token_id_out(self, recv_obj: BatchTokenIDOutput):
        ...
        return BatchStrOutput(
            ...
            output_mtp_topk_val=getattr(recv_obj, 'output_mtp_topk_val', None),
            output_mtp_topk_idx=getattr(recv_obj, 'output_mtp_topk_idx', None),
            output_mtp_draft_tokens=getattr(recv_obj, 'output_mtp_draft_tokens', None),
            output_mtp_hidden=getattr(recv_obj, 'output_mtp_hidden', None),
            output_mtp_position=getattr(recv_obj, 'output_mtp_position', None),
            output_mtp_accept_len=getattr(recv_obj, 'output_mtp_accept_len', None),
            output_mtp_accepted_hidden=getattr(recv_obj, 'output_mtp_accepted_hidden', None),
            output_mtp_accepted_tokens=getattr(recv_obj, 'output_mtp_accepted_tokens', None),
            output_mtp_prefill_hidden=getattr(recv_obj, 'output_mtp_prefill_hidden', None),
            output_mtp_prefill_tokens=getattr(recv_obj, 'output_mtp_prefill_tokens', None),
            output_mtp_prefill_position=getattr(recv_obj, 'output_mtp_prefill_position', None),
            output_mtp_prompt_hidden=getattr(recv_obj, 'output_mtp_prompt_hidden', None),
            output_mtp_prompt_ids=getattr(recv_obj, 'output_mtp_prompt_ids', None),
