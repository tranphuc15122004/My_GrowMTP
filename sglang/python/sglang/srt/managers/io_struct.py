...
class BatchTokenIDOutput(BaseBatchReq, SpeculativeDecodingMetricsMixin):
    ...
    output_mtp_topk_val: Optional[list] = None
    output_mtp_topk_idx: Optional[list] = None
    output_mtp_draft_tokens: Optional[list] = None
    output_mtp_hidden: Optional[list] = None
    output_mtp_position: Optional[list] = None
    output_mtp_accept_len: Optional[list] = None
    output_mtp_accepted_hidden: Optional[list] = None
    output_mtp_accepted_tokens: Optional[list] = None
    output_mtp_prefill_hidden: Optional[list] = None
    output_mtp_prefill_tokens: Optional[list] = None
    output_mtp_prefill_position: Optional[list] = None
    output_mtp_prompt_hidden: Optional[list] = None
    output_mtp_prompt_ids: Optional[list] = None
