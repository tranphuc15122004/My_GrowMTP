...
# MiMo has the Qwen2 configuration schema. Keep config loading local to SGLang.
...
_CONFIG_REGISTRY["mimo"] = CONFIG_MAPPING["mimo"] if "mimo" in CONFIG_MAPPING else MiMoConfig
